...
<title>OBF.Dev/Book View Reply</title>
...
<body>
	...
	<div id="titleunder" class="titleunder">Book View Reply</div>
	<hr color=#F2F2F2>
	...
	<form action="book_reply.do" method="post">
		<div id="view_all" class="view_all">
			<div id="view_all_table">
				<table width="1300" cellpadding="0" cellspacing="0" border="1"
					...
					<input type="hidden" name="bId" value="${book_reply_view.bId}">
					<input type="hidden" name="bGroup"
						value="${book_reply_view.bGroup}">
					<input type="hidden" name="bStep" value="${book_reply_view.bStep}">
					<input type="hidden" name="bIndent"
						value="${book_reply_view.bIndent}">


					<tr>
						<td align="center" height="50px"><b>번호</b></td>
						<td>${book_reply_view.bId}</td>
					</tr>


					<tr>
						<td align="center" height="50px"><b>조회수</b></td>
						<td>${book_reply_view.bHit}</td>
					</tr>
					...
					<tr>
						...
						<td style="width: 1100px;"><input type="text" name="bName"
							value="<%=session.getAttribute("login")%>"
					...
					<tr>
						...
						<td style="width: 1100px;"><textarea rows="10"
								name="bContent" style="width: 1100px; height: 500px;"></textarea></td>
					</tr>
