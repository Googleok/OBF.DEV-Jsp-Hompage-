...
<body>
	...
	<div id="book_itemdiv">
		...
		<div class="inner">
			<h1 align="center">Book about C</h1>
		</div>
		</section>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0"
			...
			<tr align="center">
				<th width="10%" style="font-size: 20px;">번호</th>
				<th width="40%" style="font-size: 20px;">제목</th>
				<th width="15%" style="font-size: 20px;">이름</th>
				<th width="25%" style="font-size: 20px;">날짜</th>
				<th width="10%" style="font-size: 20px;">조회수</th>
			</tr>
			...
			<%
						...
						for (int i = 0; i < flist.size(); i++) {
							System.out.println("book_c" + fCount);
 ...
 %> <a class="nextPage"
		...
		<%
			String lan = "c";
				...
				System.out.println("c 넣고 바로 찍어보기" + lan);
		%>
